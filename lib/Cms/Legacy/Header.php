...
*/
    ...
    */
    ...
    // Variables
    require ABS_ROOT.'../config/db_vars.php';
    ...
    // Third-party
    if (!$isInstalling) {
        $config = new \Cms\Core\Di\Config(ABS_ROOT.'../config/config.ini');
    ...
    if (!$isInstalling) {
        ...
        $repoPermission = $cmsContainer->getDoctrineRepository('Cms\Entity\Permission');
